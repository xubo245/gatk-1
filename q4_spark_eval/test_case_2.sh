...
echo 'Command,Number of executors,Executor cores,Executor memory,Exit code,Time (mins)' > test_case_2_results.csv

for num_exec in 4 8 16 32 64
do
  time_gatk "CountReadsSpark -I hdfs:///user/$USER/q4_spark_eval/WGS-G94982-NA12878.bam" $num_exec 1 1g >> test_case_2_results.csv
done

for num_exec in 2 4 8 16 32
do
  time_gatk "CountReadsSpark -I hdfs:///user/$USER/q4_spark_eval/WGS-G94982-NA12878.bam" $num_exec 2 1g >> test_case_2_results.csv
done

for num_exec in 1 2 4 8 16
do
  time_gatk "CountReadsSpark -I hdfs:///user/$USER/q4_spark_eval/WGS-G94982-NA12878.bam" $num_exec 4 1g >> test_case_2_results.csv
done