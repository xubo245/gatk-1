...
class AlignmentRegion {
    ...
    public AlignmentRegion(final String assemblyId, final String contigId, final AlnRgn alnRgn) {
        ...
        this.cigarAlong5to3DirectionOfContig = forwardStrand ? alignmentCigar : CigarUtils.invertCigar(alignmentCigar);
        this.referenceInterval = new SimpleInterval(alnRgn.getChrom(), (int) alnRgn.getPos() + 1, (int) (alnRgn.getPos() + cigarAlong5to3DirectionOfContig.getReferenceLength()));
